...
statusText.addEventListener('click', function() {
  ...
  moment.connect()
  .then(() => moment.startNotificationsMomentJS().then(handleMomentResponse))
  .then(() => {
...
function handleMomentResponse(momentResponse) {
  momentResponse.addEventListener('characteristicvaluechanged', event => {
    statusText.innerHTML = momentResponse;
  });
}
